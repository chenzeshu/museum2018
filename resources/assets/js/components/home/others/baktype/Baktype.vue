    ...
    <div class="baktype">
        ...
        >
            <Form ref="searchForm" :model="searchObj"  :label-width="80">
                <FormItem label="备份名称">
                    <Input placeholder="备份名称" v-model="searchObj.baktype_name" style="width:160px"></Input>
                </FormItem>
            </Form>
        </Modal>
        <!--新增-->
        ...
        >
            <Form ref="addForm" :model="addObj"  :label-width="80">
                <FormItem label="备份名称">
                    <Input v-model="addObj.baktype_name" style="width:200px"></Input>
                </FormItem>
            </Form>
        </Modal>
        <!--修改-->
        ...
        >
            <Form ref="editForm" :model="editObj"  :label-width="80">
                <FormItem label="备份名称">
                    <Input v-model="editObj.baktype_name" style="width:200px"></Input>
                </FormItem>
            </Form>
        </Modal>
                        ...
                        render: (h, params) => {
                            return h('div', [
                                ...
                                h('Button', {
                                    ...
                                    on: {
                                        click: () => {
                                            this.toggleDeleteModel(params.row.baktype_id)
                                        }
                                    }
                                }, '删除')
                            ]);

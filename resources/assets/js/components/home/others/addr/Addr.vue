    ...
    <div class="addr">
        ...
        >
            <Form ref="searchForm" :model="searchObj"  :label-width="80">
                <FormItem label="地点名称">
                    <Input placeholder="演出地点名称" v-model="searchObj.addr_name" style="width:160px"></Input>
                </FormItem>
            </Form>
        </Modal>
        <!--新增-->
        ...
        >
            <Form ref="addForm" :model="addObj"  :label-width="80">
                <FormItem label="演出地点">
                    <Input v-model="addObj.addr_name" style="width:200px"></Input>
                </FormItem>
            </Form>
        </Modal>
        <!--修改-->
        ...
        >
            <Form ref="editForm" :model="editObj"  :label-width="80">
                <FormItem label="演出地点">
                    <Input v-model="editObj.addr_name" style="width:200px"></Input>
                </FormItem>
            </Form>
        </Modal>
                        ...
                        render: (h, params) => {
                            return h('div', [
                                ...
                                h('Button', {
                                    ...
                                    on: {
                                        click: () => {
                                            this.toggleDeleteModel(params.row.addr_id)
                                        }
                                    }
                                }, '删除')
                            ]);

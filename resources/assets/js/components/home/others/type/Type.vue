    ...
    <div class="type">
        ...
        >
            <Form ref="searchForm" :model="searchObj"  :label-width="80">
                <FormItem label="剧种名称">
                    <Input placeholder="剧种名称" v-model="searchObj.type_name" style="width:160px"></Input>
                </FormItem>
            </Form>
        </Modal>
        <!--新增-->
        ...
        >
            <Form ref="addForm" :model="addObj"  :label-width="80">
                <FormItem label="剧种名称">
                    <Input v-model="addObj.type_name" style="width:200px"></Input>
                </FormItem>
            </Form>
        </Modal>
        <!--修改-->
        ...
        >
            <Form ref="editForm" :model="editObj"  :label-width="80">
                <FormItem label="剧种名称">
                    <Input v-model="editObj.type_name" style="width:200px"></Input>
                </FormItem>
            </Form>
        </Modal>
                        ...
                        render: (h, params) => {
                            return h('div', [
                                ...
                                h('Button', {
                                    ...
                                    on: {
                                        click: () => {
                                            this.toggleDeleteModel(params.row.type_id)
                                        }
                                    }
                                }, '删除')
                            ]);
